...
# KaraW3B.SDK.Interpreters

The KaraW3B.SDK.Interpreters package provides parsers and writers to deal with UltraStar song text file formats respecting format conventions from [UltraStar format rules](https://github.com/UltraStar-Deluxe/format)
